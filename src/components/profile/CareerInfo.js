...
<Form>
<p className='details__input'>Please enter github URL</p>
    <Form.Item
   rules={[{ required: true, message: 'Please input your github link!' }]}>
    ...
    <p className='details__input'>Please enter Linkedin URL</p>
    ...
    <p className='details__input'>Enter your Portfolio URL</p>
    <Form.Item >
    ...
    <p className='details__input'>Enter your Blogs URL(optional)</p>
    <Form.Item >
